...
main(void)
{
    ...
    //Hard Drive workaround
    UARTprintf("Spin Up wait\n\n");
    GPIOPinTypeGPIOOutput(GPIO_PORTC_BASE, GPIO_PIN_5);
    GPIOPinWrite(GPIO_PORTC_BASE, GPIO_PIN_5, 0xFF); // spin up
    SysCtlDelay(SysCtlClockGet()*3); // delay ~ 9 sec
    UARTprintf("Spin Up wait done\n\n");
